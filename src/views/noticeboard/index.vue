                ...
                <div style="margin:10px 0 0 0">
                    <e-module-model-box title="公告信息">
                        ...
                        <div class="">
                            ...
                            >
                                <span>添加人:{{ r.adder }}</span>
                                <span>点击率:{{ r.counter }}</span>
                            </e-news-list>
                        </div>
    ...
    export default {
        ...
        methods: {
            ...
            loadList(page) {
                ...
                this.$post(api.noticeboard.weblist, filter).then(res => {
                    this.loading = false;
