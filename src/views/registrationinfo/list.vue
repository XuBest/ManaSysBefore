...
<!--这是后台管理员端的，看用户活动报名信息的列表显示-->
        ...
        <el-table border :data="list" style="width: 100%" highlight-current-row
            ...
            <el-table-column label="活动编号" width="130">
                ...
                <el-table-column label="报名人" width="130">
                    <template slot-scope="{row}">
                        {{ row.adder }}
                    </template>
                </el-table-column>
            ...
            <el-table-column label="操作">
                <template slot-scope="{row}">
                    ...
                    <el-button icon="el-icon-edit" @click="$goto({path:'/admin/registrationinfoupdt',query:{id:row.id } })"
    ...
    export default {
        ...
        methods: {
            ...
            loadList( page ){
                ...
                this.$post(api.registrationinfo.list , filter).then(res=>{
                    this.loading = false;
